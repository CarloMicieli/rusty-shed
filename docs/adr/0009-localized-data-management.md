...
- **Cons:**
  _ Poor FTS5 support (cannot easily index keys/values separately).
  _ Increases IPC payload if the entire blob is sent to the UI. \* Shifts filtering logic from the DB to the Rust application layer.
