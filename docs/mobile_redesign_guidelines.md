...
<header class="sticky top-0 z-50 pt-safe">

<!-- Bottom nav: respect home indicator -->
<div class="fixed bottom-0 pb-safe">

<!-- Main scroll area: clear both nav elements -->
<div class="h-full overflow-y-auto p-4 pb-[calc(6rem_+_env(safe-area-inset-bottom,_0px))]">
```
...
<div class="overflow-x-auto md:overflow-visible">
  <div class="min-w-[420px] grid grid-cols-[2fr_1fr_1fr_1fr_1fr] ...">
...
<div class="grid grid-cols-3 gap-2 md:grid-cols-2 lg:grid-cols-3">
```
