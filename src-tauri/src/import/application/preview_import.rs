use crate::import::domain::{ImportPreview, ImportWarning, RecordCounts};
use crate::import::infrastructure::{ArchiveExtractor, DuplicateChecker, SchemaValidator};
...
impl PreviewImportUseCase {
    ...
    pub async fn execute(
        ...
        let manifest: crate::import::domain::ManifestDto = serde_json::from_value(manifest_json)
    ...
    fn check_missing_images(
        archive_path: &Path,
        manifest: &crate::import::domain::ManifestDto,
