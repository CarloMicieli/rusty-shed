...
use crate::import::application::{
    ExecuteImportUseCase, PreviewImportUseCase, ValidatePackageUseCase,
};
use crate::import::domain::{ArchiveFormat, ImportSession, ImportState, ManifestDto};
use crate::import::infrastructure::ArchiveExtractor;
...
pub async fn get_import_preview(
    ...
    let new_records = crate::import::domain::RecordCounts {
