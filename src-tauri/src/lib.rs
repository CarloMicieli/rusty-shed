...
fn create_specta_builder() -> Builder<tauri::Wry> {
    Builder::<tauri::Wry>::new()
        ...
        .commands(collect_commands![
            ...
            tracks_inventory_command_handlers::update_track_product,
            tracks_inventory_command_handlers::delete_track_product,
            tracks_inventory_command_handlers::upsert_track_product_translation,
            tracks_inventory_command_handlers::delete_track_product_translation,
