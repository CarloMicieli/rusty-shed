use crate::data_management::domain::ImageFailure;
use crate::data_management::domain::{ImportResult, ImportSession, ManifestDto, RecordCounts};
use crate::data_management::infrastructure::{ArchiveExtractor, DuplicateChecker};
use log::warn;
use sqlx::SqlitePool;
...
mod tests {
    ...
    async fn test_execute_import_with_no_duplicates() {
        ...
        let session = ImportSession::new(
            ...
            crate::data_management::domain::ArchiveFormat::Zip,
        );
        let manifest = ManifestDto {
            ...
            exported_at: None,
            source: None,
            data: crate::data_management::domain::DataContainerDto::default(),
        };
