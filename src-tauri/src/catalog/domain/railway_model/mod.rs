...
pub(crate) mod coupler_repository;
pub(crate) mod coupler_type;
pub(crate) mod coupler_type_id;
mod coupling;
...
pub use coupler_repository::{CouplerRepository, CouplerUowExt};
pub use coupler_type::CouplerType;
pub use coupler_type_id::CouplerTypeId;
