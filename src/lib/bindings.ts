...
async listCollectionItems(search: string | null) : Promise<Result<CollectionItemLite[], CommandError>> {
    try {
...
async createCollectionItem(input: CreateCollectionItemInput) : Promise<Result<CollectionItemLite, CommandError>> {
    try {
...
async updateCollectionItem(input: UpdateCollectionItemInput) : Promise<Result<CollectionItemLite, CommandError>> {
    try {
 ...
 */
export type AddMaintenanceInput = { id: string; maintenance_card_id: string; date_performed: string; maintenance_type: string | null; notes: string | null }
export type AddToWishlistInput = { wishlistId: string; railwayModelId: string; priority: WishlistPriority | null; status: WishlistStatus | null; desiredPriceAmount: bigint | null; desiredPriceCurrency: string | null; notes: string | null; addedDate: string | null }
/**
 ...
 */
export type CollectionItemLite = { id: string; brand: string; catalogNumber: string; title: string; scale: string; powerSystem: string; description: string | null; tags: string[]; createdAt: string }
/**
...
export type CouplingInput = { socket: string; close_couplers: string | null; digital_shunting: string | null }
 ...
 */
export type CreateCollectionItemInput = { brand: string; catalogNumber: string; title: string; scale: string; powerSystem: string; description: string | null; tags: string[] }
/**
 * Input for creating a new railway model (domain-level DTO).
 */
export type CreateRailwayModelInput = { manufacturer_id: string; product_code: string; description: string; details: string | null; power_method: string; scale: string; epoch: string; category: string; delivery_date: string | null; availability_status: string | null; rolling_stocks: CreateRollingStockInput[] }
/**
 * Input for creating a rolling stock (tagged union by category).
 */
export type CreateRollingStockInput = { category: "Locomotive"; railway_company_id: string; class_name: string; road_number: string; series: string | null; depot: string | null; livery: string | null; locomotive_type: string; is_dummy: boolean | null; control: string | null; dcc_interface: string | null; length_over_buffers: LengthOverBuffersInput | null; technical_specifications: TechnicalSpecificationsInput | null } | { category: "PassengerCar"; railway_company_id: string; type_name: string; road_number: string | null; series: string | null; depot: string | null; livery: string | null; passenger_car_type: string; service_level: string | null; length_over_buffers: LengthOverBuffersInput | null; technical_specifications: TechnicalSpecificationsInput | null } | { category: "FreightCar"; railway_company_id: string; type_name: string; road_number: string | null; series: string | null; depot: string | null; livery: string | null; freight_car_type: string | null; length_over_buffers: LengthOverBuffersInput | null; technical_specifications: TechnicalSpecificationsInput | null } | { category: "Railcar"; railway_company_id: string; type_name: string; road_number: string | null; series: string | null; depot: string | null; livery: string | null; control: string | null; dcc_interface: string | null; length_over_buffers: LengthOverBuffersInput | null; technical_specifications: TechnicalSpecificationsInput | null } | { category: "ElectricMultipleUnit"; railway_company_id: string; type_name: string; road_number: string | null; series: string | null; depot: string | null; livery: string | null; electric_multiple_unit_type: string; is_dummy: boolean | null; control: string | null; dcc_interface: string | null; length_over_buffers: LengthOverBuffersInput | null; technical_specifications: TechnicalSpecificationsInput | null }
export type CreateSellerPayload = { name: string; type: SellerType; url: string | null; email: string | null; phone: string | null; websiteUrl: string | null; street: string | null; houseNumber: string | null; city: string | null; stateRegion: string | null; postalCode: string | null; countryCode: string | null }
 ...
 */
"JPY"
export type DashboardDepotEntry = { id: string; manufacturer: string | null; productCode: string | null; category: string | null; scale: string | null; railwayCompany: string | null; description: string | null }
export type DashboardRecentItem = { id: string; title: string; subtitle: string | null }
export type DashboardSummary = { totals: DashboardTotals; recentItems: DashboardRecentItem[]; depotItems: DashboardDepotEntry[] }
export type DashboardTotals = { collectionItems: number; wishlists: number; maintenanceDue: number; totalValue: MonetaryAmountSummary | null }
/**
 ...
 */
"Scale00"
export type Seller = { id: SellerId; name: string; type: SellerType; url: string | null; email: string | null; phone: string | null; websiteUrl: string | null; street: string | null; houseNumber: string | null; city: string | null; stateRegion: string | null; postalCode: string | null; countryCode: string | null; createdAt: string; updatedAt: string }
/**
 * Strongly-typed identifier for a seller. Format: `trn:seller:{slug}`.
 */
export type SellerId = string
export type SellerType = "SHOP" | "PRIVATE" | "MARKETPLACE" | "DISTRIBUTOR"
/**
...
export type TechnicalSpecificationsInput = { minimum_radius: number | null; coupling: CouplingInput | null; flywheel_fitted: string | null; body_shell: string | null; chassis: string | null; interior_lights: string | null; lights: string | null; sprung_buffers: string | null }
/**
 ...
 */
export type WishlistPreview = { id: WishlistId; name: string; notes: string | null; is_default: boolean; count: bigint; updated_at: string; total_value: Partial<{ [key in Currency]: bigint }> }
/**
