 ...
 */
export type CreateRollingStockInput = { category: "Locomotive"; railway_company_id: string; friendly_name: string; series_code: string; road_number: string; series: string | null; depot: string | null; livery: string | null; locomotive_type: string; is_dummy: boolean | null; control: string | null; dcc_interface: string | null; length_over_buffers: LengthOverBuffersInput | null; technical_specifications: TechnicalSpecificationsInput | null } | { category: "PassengerCar"; railway_company_id: string; friendly_name: string; series_code: string; road_number: string | null; series: string | null; depot: string | null; livery: string | null; passenger_car_type: string; service_level: string | null; length_over_buffers: LengthOverBuffersInput | null; technical_specifications: TechnicalSpecificationsInput | null } | { category: "FreightCar"; railway_company_id: string; friendly_name: string; series_code: string; road_number: string | null; series: string | null; depot: string | null; livery: string | null; freight_car_type: string | null; length_over_buffers: LengthOverBuffersInput | null; technical_specifications: TechnicalSpecificationsInput | null } | { category: "Railcar"; railway_company_id: string; friendly_name: string; series_code: string; road_number: string | null; series: string | null; depot: string | null; livery: string | null; control: string | null; dcc_interface: string | null; length_over_buffers: LengthOverBuffersInput | null; technical_specifications: TechnicalSpecificationsInput | null } | { category: "ElectricMultipleUnit"; railway_company_id: string; friendly_name: string; series_code: string; road_number: string | null; series: string | null; depot: string | null; livery: string | null; electric_multiple_unit_type: string; is_dummy: boolean | null; control: string | null; dcc_interface: string | null; length_over_buffers: LengthOverBuffersInput | null; technical_specifications: TechnicalSpecificationsInput | null }
