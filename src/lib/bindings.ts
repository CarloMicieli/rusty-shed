...
export const commands = {
  ...
  async getRailwayModelById(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_railway_model_by_id', { railwayModelId, lang })
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async getRailwayModelTranslations(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_railway_model_translations', { railwayModelId })
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
  ...
  async upsertRailwayModelTranslation(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('upsert_railway_model_translation', { args })
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: 'error', error: e as any };
