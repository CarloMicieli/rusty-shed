 ...
 */
quantity: bigint }
export type SettingsDto = { id: bigint; currency: Currency; lengthUnit: MeasureUnit; favoriteScale: Scale; favoritePowerMethod: PowerMethod; languageCode: string; theme: ThemeValue }
/**
...
export type UpdateSettingsPayload = { currency: Currency; lengthUnit: MeasureUnit; favoriteScale: Scale; favoritePowerMethod: PowerMethod; languageCode: string; theme: ThemeValue }
/**
