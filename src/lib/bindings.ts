 ...
 * `CommandError` and returned to the caller.
 */
async getRailwayModelById(railwayModelId: RailwayModelId) : Promise<Result<RailwayModel | null, CommandError>> {
    try {
 ...
 */
async createRailwayModel(newRailwayModel: CreateRailwayModelInput) : Promise<Result<RailwayModelId, CommandError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("create_railway_model", { newRailwayModel }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 * - `Err(CommandError)` when the use-case returns an error.
 */
async getDashboardSummary(params: QueryParams | null) : Promise<Result<DashboardSummary, CommandError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("get_dashboard_summary", { params }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
rolling_stocks: OwnedRollingStockView[]; 
/**
 ...
 */
{ category: "Locomotive"; railway_company_id: string; friendly_name: string; series_code: string; road_number: string; series: string | null; depot: string | null; livery: string | null; locomotive_type: string; is_dummy: boolean | null; control: string | null; dcc_interface: string | null; length_over_buffers: LengthOverBuffersInput | null; technical_specifications: TechnicalSpecificationsInput | null } | 
/**
 * Passenger car-specific input fields.
 */
{ category: "PassengerCar"; railway_company_id: string; friendly_name: string; series_code: string; road_number: string | null; series: string | null; livery: string | null; passenger_car_type: string; service_level: string | null; length_over_buffers: LengthOverBuffersInput | null; technical_specifications: TechnicalSpecificationsInput | null } | 
/**
 * Freight car-specific input fields.
 */
{ category: "FreightCar"; railway_company_id: string; friendly_name: string; series_code: string; road_number: string | null; series: string | null; livery: string | null; freight_car_type: string | null; length_over_buffers: LengthOverBuffersInput | null; technical_specifications: TechnicalSpecificationsInput | null } | 
/**
 * Railcar-specific input fields.
 */
{ category: "Railcar"; railway_company_id: string; friendly_name: string; series_code: string; road_number: string | null; series: string | null; depot: string | null; livery: string | null; railcar_type: string | null; is_dummy: boolean | null; control: string | null; dcc_interface: string | null; length_over_buffers: LengthOverBuffersInput | null; technical_specifications: TechnicalSpecificationsInput | null } | 
/**
 * Electric multiple unit-specific input fields.
 */
{ category: "ElectricMultipleUnit"; railway_company_id: string; friendly_name: string; series_code: string; road_number: string | null; series: string | null; depot: string | null; livery: string | null; electric_multiple_unit_type: string; is_dummy: boolean | null; control: string | null; dcc_interface: string | null; length_over_buffers: LengthOverBuffersInput | null; technical_specifications: TechnicalSpecificationsInput | null }
 ...
 */
rolling_stocks: DepotRollingStockView[] }
/**
 ...
 */
number_of_recent_items: number | null; 
/**
 * Number of depot entries to retrieve for the dashboard.
 */
number_of_depot_entries: number | null }
/**
