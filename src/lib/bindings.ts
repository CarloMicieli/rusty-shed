 ...
 */
seriesCode: string; roadNumber: string | null; livery: string | null; depot: string | null; series: string | null; friendlyName: string | null; flywheelFitted: boolean | null; bodyShell: string | null; chassis: string | null; interiorLights: string | null; lights: string | null; sprungBuffers: boolean | null; 
/**
