 ...
 */
async getManufacturerById(manufacturerId: ManufacturerId) : Promise<Result<Manufacturer | null, CommandError>> {
    try {
 ...
 * `CommandError` and returned to the caller.
 */
async getRailwayModelById(railwayModelId: RailwayModelId, lang: Language) : Promise<Result<RailwayModelView | null, CommandError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("get_railway_model_by_id", { railwayModelId, lang }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 * `CommandError` and returned to the caller.
 */
async getRailwayCompanyById(railwayCompanyId: RailwayCompanyId) : Promise<Result<RailwayCompany | null, CommandError>> {
    try {
 ...
 */
async createRailwayModel(args: CreateRailwayModelArgs) : Promise<Result<RailwayModelId, CommandError>> {
    try {
 ...
 * - `Err(CommandError::DatabaseError)` on persistence failure.
 */
async updateRollingStockIdentification(args: UpdateRollingStockIdentificationArgs) : Promise<Result<null, CommandError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("update_rolling_stock_identification", { args }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 * - `Err(CommandError::DatabaseError)` on persistence failure.
 */
async updateRailwayModelClassification(args: UpdateRailwayModelClassificationArgs) : Promise<Result<null, CommandError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("update_railway_model_classification", { args }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 * - `Err(CommandError::DatabaseError)` on persistence failure.
 */
async updateRailwayModelDeliveryDate(args: UpdateRailwayModelDeliveryDateArgs) : Promise<Result<null, CommandError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("update_railway_model_delivery_date", { args }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 * - `Err(CommandError::DatabaseError)` on persistence failure.
 */
async updateRollingStockRailwayCompany(args: UpdateRollingStockRailwayCompanyArgs) : Promise<Result<null, CommandError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("update_rolling_stock_railway_company", { args }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 * - `Err(CommandError::DatabaseError)` on persistence failure.
 */
async updateRollingStockCategory(args: UpdateRollingStockCategoryArgs) : Promise<Result<null, CommandError>> {
    try {
 ...
 * - `Err(CommandError::DatabaseError)` on persistence failure.
 */
async updateRollingStockSubcategory(args: UpdateRollingStockSubcategoryArgs) : Promise<Result<null, CommandError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("update_rolling_stock_subcategory", { args }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 * - `Err(CommandError::DatabaseError)` on persistence failure.
 */
async updateRollingStockServiceLevel(args: UpdateRollingStockServiceLevelArgs) : Promise<Result<null, CommandError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("update_rolling_stock_service_level", { args }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 * - `Err(CommandError::DatabaseError)` on persistence failure.
 */
async updateRollingStockDcc(args: UpdateRollingStockDccArgs) : Promise<Result<null, CommandError>> {
    try {
 ...
 * - `Err(CommandError::DatabaseError)` on persistence failure.
 */
async updateRollingStockSpecifications(args: UpdateRollingStockSpecificationsArgs) : Promise<Result<null, CommandError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("update_rolling_stock_specifications", { args }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async getRailwayModelTranslations(railwayModelId: RailwayModelId) : Promise<Result<RailwayModelTranslations | null, CommandError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("get_railway_model_translations", { railwayModelId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async upsertRailwayModelTranslation(args: UpsertRailwayModelTranslationArgs) : Promise<Result<null, CommandError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("upsert_railway_model_translation", { args }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async searchRailwayModels(args: SearchRailwayModelsArgs) : Promise<Result<RailwayModelId[], CommandError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("search_railway_models", { args }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async addRollingStockToModel(args: AddRollingStockToModelArgs) : Promise<Result<RollingStockId, CommandError>> {
    try {
 ...
 */
async addRailwayModelToCollection(args: AddRailwayModelToCollectionArgs) : Promise<Result<null, CommandError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("add_railway_model_to_collection", { args }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async recordAcquisition(args: RecordAcquisitionArgs) : Promise<Result<CollectionItemId[], CommandError>> {
    try {
...
async updateCollectionItem(args: UpdateCollectionItemArgs) : Promise<Result<null, CommandError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("update_collection_item", { args }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async removeCollectionItem(args: RemoveCollectionItemArgs) : Promise<Result<CollectionItemId, CommandError>> {
    try {
 ...
 */
async addRailwayModelToWishList(args: AddRailwayModelToWishListArgs) : Promise<Result<null, CommandError>> {
    try {
 ...
 * - `Err(CommandError)` when the use-case returns an error.
 */
async getDashboardSummary(criteria: QueryCriteria | null) : Promise<Result<DashboardSummary, CommandError>> {
    try {
 ...
 */
async updateWishlistItem(args: UpdateWishlistItemArgs) : Promise<Result<WishlistItem, CommandError>> {
    try {
 ...
 */
async getMaintenanceCard(cardId: MaintenanceCardId) : Promise<Result<MaintenanceCardView | null, CommandError>> {
    try {
 ...
 */
async addMaintenanceCard(ownedRollingStockId: OwnedRollingStockId) : Promise<Result<MaintenanceCardId, CommandError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("add_maintenance_card", { ownedRollingStockId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async createTrackInventory(input: NewTrackInventoryArgs) : Promise<Result<TrackInventoryId, CommandError>> {
    try {
 ...
 */
async addTrackPurchase(input: AddTrackPurchaseArgs) : Promise<Result<TrackPurchaseId, CommandError>> {
    try {
 ...
 */
async newDigitalRollingStock(args: NewDigitalRollingStockArgs) : Promise<Result<ResponseNewDigitalRollingStock, CommandError>> {
    try {
 ...
 */
async checkDccAddressDuplicate(args: CheckDccAddressDuplicateArgs) : Promise<Result<CheckDuplicateAddressResult, CommandError>> {
    try {
 ...
 */
async getInstallableRollingStocks() : Promise<Result<InstallableRollingStockView[], CommandError>> {
    try {
 ...
 */
async analyzeImportPackage(args: AnalyzeImportPackageArgs) : Promise<Result<AnalyzeImportPackageResponse, CommandError>> {
    try {
 ...
 */
async getImportPreview(args: GetImportPreviewArgs) : Promise<Result<ImportPreviewResponse, CommandError>> {
    try {
 ...
 */
async executeImport(args: ExecuteImportArgs) : Promise<Result<ImportResultResponse, CommandError>> {
    try {
 ...
 */
async cancelImportSession(args: CancelImportSessionArgs) : Promise<Result<CancelImportSessionResponse, CommandError>> {
    try {
 ...
 */
async getMonthlyBudgetRecords(args: GetMonthlyBudgetRecordsArgs) : Promise<Result<MonthlyBudgetRecordDto[], CommandError>> {
    try {
 ...
 */
async getExtraBudgets(args: GetExtraBudgetsArgs) : Promise<Result<ExtraBudgetDto[], CommandError>> {
    try {
 ...
 */
async getQuarterlySummaries(args: GetQuarterlySummariesArgs) : Promise<Result<QuarterlySummary[], CommandError>> {
    try {
 ...
 * - Model ID is invalid
 */
async getRailwayModelImage(railwayModelId: RailwayModelId) : Promise<Result<RailwayModelImageResponse, CommandError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("get_railway_model_image", { railwayModelId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 * - Storage operations fail
 */
async uploadModelImageBytes(args: UploadModelImageBytesArgs) : Promise<Result<null, CommandError>> {
    try {
...
async getLocale() : Promise<string | null> {
    return await TAURI_INVOKE("get_locale");
},
/**
 * Export the database to a user-selected file location
 */
async exportDatabase(args: ExportDatabaseArgs) : Promise<Result<ExportDatabaseResponse, CommandError>> {
    try {
 ...
 */
async importDatabase(args: ImportDatabaseArgs) : Promise<Result<ImportDatabaseResponse, CommandError>> {
    try {
 ...
 */
async globalSearch(args: GlobalSearchArgs) : Promise<Result<GlobalSearchResultView[], CommandError>> {
    try {
 ...
 */
export type BackupListItem = { id: string; label: string; createdAt: string; sizeBytes: bigint; sizeFormatted: string; recordCount: bigint; isInitial: boolean }
/**
 ...
 */
export type BudgetConfigDto = { id: number; mode: BudgetMode; baseAmount: bigint; monthlyAmount: bigint; yearlyAmount: bigint; currency: Currency; lastResetYear: number; createdAt: string; updatedAt: string; version: number }
/**
 ...
 */
{ kind: "seller"; data: { seller_id: string | null } } | 
/**
 * Set or clear purchased price in minor units.
 */
{ kind: "price"; data: { amount: bigint | null; currency: string | null } } | 
/**
 * Set or clear purchase date.
 */
{ kind: "purchaseDate"; data: { purchase_date: string | null } } | 
/**
 * Set or clear added date.
 */
{ kind: "addedDate"; data: { added_date: string | null } } | 
/**
 * Set or clear notes.
 */
{ kind: "notes"; data: { notes: string | null } } | 
/**
 * Set or clear purchase condition.
 */
{ kind: "purchaseCondition"; data: { purchase_condition: string | null } } | 
/**
 * Set or clear model condition.
 */
{ kind: "modelCondition"; data: { model_condition: string | null } } | 
/**
 * Set or clear box condition.
 */
{ kind: "boxCondition"; data: { box_condition: string | null } }
/**
 ...
 */
railcarsCount: number; starterSetsCount: number; 
/**
 ...
 */
export type ConnectionStatusResponse = { isConnected: boolean; email: string | null; connectedAt: string | null; lastSyncAt: string | null }
/**
...
export type ExportDatabaseResponse = { file_path: string; file_size_bytes: bigint; duration_ms: bigint; message: string }
/**
 * Export preview information
 */
export type ExportPreview = { railway_model_count: number; collection_item_count: number; seller_count: number; maintenance_log_count: number; dcc_roster_count: number; image_count: number; orphaned_image_count: number; estimated_size_bytes: bigint; warnings: string[] }
/**
 ...
 */
export type ExtraBudgetDto = { id: string; year: number; month: number; amount: bigint; currency: Currency; reason: string | null; createdAt: string; version: number }
/**
...
export type ImportDatabaseResponse = { file_path: string; file_size_bytes: bigint; duration_ms: bigint; message: string; requires_restart: boolean }
/**
 * Import outcome
 */
 ...
 */
export type MonthlyBudgetRecordDto = { year: number; month: number; baseBudget: bigint; extraBudget: bigint; actualSpend: bigint; rolloverIn: bigint; rolloverOut: bigint; available: bigint; remaining: bigint; remainingPercentage: number; status: string; currency: Currency }
/**
 ...
 */
export type QuarterlyActivityPoint = { year: number; quarter: BudgetQuarter; spendingLevel: SpendingLevel; amount: bigint }
/**
 * Summary of spending for a quarter with category breakdown.
 */
export type QuarterlySummary = { year: number; quarter: BudgetQuarter; totalSpending: MonetaryAmount; categoryBreakdown: CategorySpending[] }
/**
 ...
 */
export type RailwayModelTranslations = { railway_model_id: RailwayModelId; en: RailwayModelTranslationEntry | null; it: RailwayModelTranslationEntry | null }
/**
 ...
 */
export type RecordCounts = { manufacturers: number; railwayCompanies: number; railwayModels: number; collectionItems: number; sellers: number; maintenanceCards: number; trackProducts: number; trackInventories: number }
/**
 ...
 */
export type RollingStockView = { electricMultipleUnit: { 
/**
 ...
 */
freight_car_type: FreightCarType | null } } | { passengerCar: { 
/**
 * Identifier for this rolling stock instance.
 */
id: RollingStockId; 
 ...
 */
service_level: ServiceLevel | null } } | { railcar: { 
/**
 * Identifier for this rolling stock instance.
 */
id: RollingStockId; 
 ...
 */
export type SellerEvent = { created: { aggregate_id: SellerId; name: string; seller_type: SellerType; email: string | null; phone: string | null; website_url: string | null; address: Address | null; created_at: string; updated_at: string } } | { updated: { aggregate_id: SellerId; name: string; seller_type: SellerType; email: string | null; phone: string | null; website_url: string | null; address: Address | null; created_at: string; updated_at: string } } | { deleted: { aggregate_id: SellerId } }
/**
 ...
 */
export type SimplifiedRailwayModelArgs = { manufacturerId: string; productCode: string; description: string; category: string; scale: string; epoch: string; powerMethod: string; rollingStocks: SimplifiedRollingStockArgs[] }
export type SimplifiedRollingStockArgs = { railwayCompanyId: string; seriesCode: string; roadNumber: string | null; subcategory: string | null; category: string }
/**
 ...
 */
export type SyncStatusResponse = { operationId: string | null; isSyncing: boolean; progressPercent: number; statusMessage: string }
/**
 ...
 */
seriesCode: string; roadNumber: string | null; livery: string | null; depot: string | null; flywheelFitted: boolean | null; bodyShell: string | null; chassis: string | null; interiorLights: string | null; lights: string | null; 
/**
 * Only relevant for motorised rolling stock (Locomotive, EMU, Railcar).
 */
dccInterface: DccInterface | null; control: Control | null; couplingSocket: string | null; closeCouplers: boolean | null; digitalShunting: boolean | null }
/**
 ...
 */
export type WishlistPreview = { id: WishlistId; name: string; notes: string | null; isDefault: boolean; count: bigint; updatedAt: string; totalValue: Partial<{ [key in Currency]: bigint }> }
/**
