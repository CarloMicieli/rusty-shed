 ...
 * `CommandError` and returned to the caller.
 */
async getRailwayModelById(railwayModelId: RailwayModelId, lang: string) : Promise<Result<RailwayModelView | null, CommandError>> {
    try {
 ...
 */
export type RailwayModelTranslations = { railwayModelId: RailwayModelId; en: RailwayModelTranslationEntry | null; it: RailwayModelTranslationEntry | null }
/**
 ...
 */
export type UpsertRailwayModelTranslationArgs = { railwayModelId: RailwayModelId; lang: string; description: string | null; details: string | null }
/**
