...
const nameRequiredMessage = getMessage('seller_form_validation_name_required', 'Seller name is required');
const invalidEmailMessage = getMessage('seller_form_validation_email_invalid', 'Invalid email address');
