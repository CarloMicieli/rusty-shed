...
- **Type Safety**: Use `tauri-specta` bindings; never redefine types.
...
3. **Format & Lint**: Run project formatters and Clippy/ESLint.
4. **Verify**: Run `svelte-check`, Vitest, and Cargo tests.
